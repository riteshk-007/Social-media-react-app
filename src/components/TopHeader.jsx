...
function TopHeader() {
  ...
  return (
    ...
    {/*  menu buttons */}
          ...
          <HiHome className='text-white cursor-pointer text-lg mx-7'onClick={()=>navigate('/')}/>
          <AiOutlineMessage className='text-white cursor-pointer text-lg mx-7' onClick={()=>navigate('/message')}/>
          <GoBell className='text-white cursor-pointer text-lg mx-7' onClick={()=>navigate('/notification')}/>
